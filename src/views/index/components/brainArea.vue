...
export default {
  ...
  methods: {
    ...
    linkTo (areaName) {const t = `../cirro/index.html#q={"dataset":"scVI","embeddings":[{"name":"X_umap","dimensions":2}],"layers":[],"activeFeature":{"name":"organ","type":"obsCat","embeddingKey":"organ_X_umap"},"q":[{"id":"organ","type":"obsCat"}],"datasetFilter":{"organ":{"value":["${areaName}"],"operation":"in"}},"embeddingLabels":["celltype"]}`; window.location.href = t;},
